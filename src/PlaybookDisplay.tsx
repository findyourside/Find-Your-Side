    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Your 4-Week Action Plan</h1>
          <h2 className="text-2xl font-semibold text-indigo-600 mb-3">{playbook.businessName}</h2>
